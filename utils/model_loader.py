...
class ModelLoader:
    ...
    def InceptionResNetV2(self):
        ...
        up = Lambda(self.scaling, output_shape=up.shape[1:], arguments={'scale': 0.17})(up)
        x = add([x, up])
        ...
        up = Lambda(self.scaling, output_shape=up.shape[1:], arguments={'scale': 0.1})(up)
        x = add([x, up])
        ...
        up = Lambda(self.scaling, output_shape=up.shape[1:], arguments={'scale': 0.2})(up)
        x = add([x, up])
        ...
        up = Lambda(self.scaling, output_shape=up.shape[1:], arguments={'scale': 1})(up)
        x = add([x, up])
